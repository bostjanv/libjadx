...
| Maven coordinates | `io.github.skylot:jadx-core:1.5.6`; `io.github.skylot:jadx-gui:1.5.6` (test scope only) | Both POMs return HTTP 200 from Maven Central; `jadx-core` metadata reports 1.5.6 as latest and release |
